...
export default function Representatives() {
  ...
  return (
    <div className="c_container !mt-[220px]">
      ...
      <div className="relative my-12" dir="ltr">
        <div
          ref={emblaRef}
          className="overflow-hidden w-full rounded-xl"
          aria-label="Auto-playing infinite carousel"
        >
          <div className="flex">
            {representatives.map((rep, i) => (
              <div
                key={i}
                className="flex-[0_0_80%] sm:flex-[0_0_50%] md:flex-[0_0_20%] 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {representatives.map((rep, i) => (
          ...
          >
            ...
            <p className="text-purple-600 font-semibold text-center !mt-4 cursor-pointer">{rep.phone}</p>
          </div>
        ))}
      </div>
    </div>
